...
function showSuccessMessage() {
    ...
    // Try to append to main.auth-container, fallback to .auth-container, then body
    const container = document.querySelector('main.auth-container') || document.querySelector('.auth-container') || document.body;
